...
public class Services {
	 ...
	 * 
	 * waitForElementToBeClickable(driver, Xpath); getWebElement(driver,
	 * Xpath).click();
	 * 
	 * }
	 */
	/*
	 * public static void Login(WebDriver driver, boolean admin) throws
	 * InterruptedException {
	 * 
	 * com.cucumber.framework.configreader.ConfigFileReader configFileReader = new
	 * com.cucumber.framework.configreader.ConfigFileReader();
	 * driver.get(configFileReader.getApplicationUrl());
	 * driver.manage().window().maximize();
	 * 
	 * if (admin == true) {
	 * driver.findElement(emailtxTxtfield).sendKeys(configFileReader.userName());
	 * driver.findElement(passwordTxtfield).sendKeys(configFileReader.password());
	 * driver.findElement(loginBttn).click(); driver.manage().window().maximize(); }
	 * 
	 * else {
	 * 
	 * driver.findElement(emailtxTxtfield).sendKeys(configFileReader.
	 * companyAdminName());
	 * driver.findElement(passwordTxtfield).sendKeys(configFileReader.
	 * companyAdminPassword()); driver.findElement(loginBttn).click();
	 * driver.manage().window().maximize(); }
	 * 
	 * }
	 * 
	...
	/*
	 * public static void sendKeysbyXpath(WebDriver driver, By Xpath,
	 * CharSequence... keysToSend) throws InterruptedException {
	 * 
	 * WebDriverWait wait = new WebDriverWait(driver, 30);
	 * wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(Xpath));
	 * WebElement wl = getWebElement(driver, Xpath); wl.sendKeys(keysToSend); }
	 */
